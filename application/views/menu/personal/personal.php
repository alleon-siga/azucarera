...
<ul class="breadcrumb breadcrumb-top">
    <li>Configuracion</li>
    <li><a href="">Agregar y editar Personal</a></li>
</ul>
            ...
            <?php if (count($personales) > 0) {
                ...
                foreach ($personales as $personal) {
                    ...
                    <tr>
                        ...
                        <td class="center"><?= $personal->id ?></td>
...
<script type="text/javascript">
    ...
    function editar(id) {
        ...
        $("#agregar").load('<?= $ruta ?>personal/form/'+id);
        $('#agregar').modal('show');
    }

    function agregar() {

        $("#agregar").load('<?= $ruta ?>personal/form');
        $('#agregar').modal('show');
    }
    ...
    var grupo = {
        ...
        guardar : function () {
            if ($("#codigo").val() == '') {
                ...
                $.bootstrapGrowl('<h4>Debe ingresar un codigo</h4>', {
                    type: growlType,
                    delay: 2500,
                    allow_dismiss: true
                });
    ...
    <form name="formeliminar" id="formeliminar" method="post" action="<?= $ruta ?>clientesgrupos/eliminar">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Est&aacute; seguro que desea eliminar el Personal seleccionado?</p>
